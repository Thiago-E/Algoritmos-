...
void setup()
{
  ...
  do
  {
    ...
    switch(escolhaDaOperacao){
      ...
      Serial.println("Top!!! O resultado eh: " + String(soma));
      break;


      case 2:
      subtracao = numero1 - numero2;
      Serial.println("Top!!! O resultado eh: " + String(subtracao));
      break;

      case 3:
      multiplicacao = numero1 * numero2;
      Serial.println("Top!!! O resultado eh: " + String(multiplicacao));
      break;

      case 4 :
      divisao = numero1 / numero2;
      Serial.println("Top!!! O resultado eh: " + String(divisao));
      break;
    }
